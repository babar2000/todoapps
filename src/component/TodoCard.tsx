...
const TodoCard: FC<TodoCardType> = ({todoItem, onStatusChange,onEdit, onDelete ,isDarkMode}) => {
    ...
    return (
        <>
            ...
            <div className={` max-w-sm w-full   sm:p-4  py-6 px-2  shadow-lg   dark:text-[#9fb9d0] dark:bg-[#232d35] bg-gray-200  } `}
                ...
                <div className="flex justify-between mb-4 items-center">
                    <div className="flex items-center">
                        ...
                        <div className="py-1 px-2 flex-shrink-0 sm:text-sm">{formatDate(todoItem.date)}</div>
                    </div>
                    <div
                ...
                <div className="flex justify-center">
                    <div className={`  text-center h-1.5  w-20 rounded-full mb-4 dark:bg-[#9fb9d0] bg-gray-900 `}></div>
                </div>
