...
const Search: FC<SearchProps> = ({ searchTerm, onSearchChange, onAddTodoButtonClick }) => {
    ...
    return (
        <div className="pt-10 flex justify-center">
            <div className="mt-1 flex rounded-xl shadow-sm w-full sm:w-2/3 px-2 sm:text-xl dark:bg-[#232d35] dark:text-[#9eb8cf] bg-[#8ab6d6]">
                <input
                    value={searchTerm}
